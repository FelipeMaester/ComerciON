            ...
            {users.map((user) => (
              <tr key={user.id} className="border-t border-slate-100">
                ...
                <td className="px-4 py-2 text-right">
                  <button onClick={() => toggleActive(user)} className="text-slate-500 hover:text-slate-900">
...
function CreateUserForm({ onCreated }: { onCreated: () => void }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="mb-6 grid grid-cols-1 gap-3 rounded-lg border border-slate-200 bg-white p-4 sm:grid-cols-2">
