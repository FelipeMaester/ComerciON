    ...
    <div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <section className="rounded-lg border border-slate-200 bg-white p-4">
          ...
          <p className="mb-3 text-xs text-slate-500">Usada no dashboard para mostrar o progresso do mês.</p>
          <div className="flex flex-wrap items-end gap-2">
            ...
            <label className="text-sm">
              <span className="mb-1 block text-slate-600">Meta (R$)</span>
              <input
                type="number"
                min={0}
                step="0.01"
          ...
          {goalSaved && <p className="mt-2 text-sm text-emerald-600">Meta salva.</p>}
          {goalError && (
            <div className="mt-2">
        ...
        <section className="rounded-lg border border-slate-200 bg-white p-4 lg:col-span-2">
          ...
          <div className="mb-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              <div className="mb-1 text-xs font-medium uppercase text-slate-400">Período A</div>
            ...
            <div>
              <div className="mb-1 text-xs font-medium uppercase text-slate-400">Período B</div>
              <div className="flex gap-2">
  ...
  return (
    <div className="rounded-lg border border-slate-100 p-3 text-sm">
      ...
      <div className="flex justify-between text-slate-500">
        ...
        <span className="text-slate-900">R$ {stats.total.toFixed(2)}</span>
      </div>
      <div className="flex justify-between text-slate-500">
        <span>Vendas</span>
        <span className="text-slate-900">{stats.count}</span>
      </div>
      <div className="flex justify-between text-slate-500">
        <span>Ticket médio</span>
        <span className="text-slate-900">R$ {stats.averageTicket.toFixed(2)}</span>
      </div>
    </div>
  );
}
